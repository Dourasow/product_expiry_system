                                ...
                                <div class="tab-pane fade in mt-2" id="keyboard">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-2" >
                                      <form method="post" action="purchase.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
                                          <div class="products">
                                              <h6 class="text-info"><?php echo $product['NAME']; ?></h6>
                                              <h6>NGN <?php echo $product['COST']; ?></h6>
                                              <input type="text" name="quantity" class="form-control" value="1" />
                                              <input type="hidden" name="name" value="<?php echo $product['NAME']; ?>" />  <input type="hidden" name="cat" value="<?php echo $product['CATEGORY_ID']; ?>" />
                                              <input type="hidden" name="cost" value="<?php echo $product['COST']; ?>" /> <input type="hidden" name="code" value="<?php echo $product['PRODUCT_CODE']; ?>" />
