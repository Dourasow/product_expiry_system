                                    ...
                                    <div class="col-sm-4 col-md-2" >
                                      <form method="post" action="pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
                                          <div class="products">
                                              ...
                                              <input type="text" name="quantity" class="form-control" value="1" />  <input type="hidden" name="squantity" class="form-control" value="1" />  <input type="hidden" name="name" class="form-control" value="<?php echo $product['NAME']; ?>" />
