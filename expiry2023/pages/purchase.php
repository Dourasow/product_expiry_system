...
<html>
<head>
   <script type="text/javascript" src="assets/p/js.js"></script>
       <!-- Including our scripting file. -->
       <script type="text/javascript" src="assets/p/scripts.js"></script>
  <title></title>
</head>
</html>
<?php
    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                     <input type="text" id="search" placeholder="Search Item(s) or Product Bar Code" class="form-control" />
                     <script>
...
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Purchases</h4>
        </div>
      ...
      <div class="card-body col-md-9">
        ...
        <!-- trial form lang   -->
<form role="form" method="post" action="pur_transac.php?action=add">
        ...
        <td>
          ...
          <td>
           ...
           <td>
            ...
            NGN <?php echo $product['cost']; ?>
          </td> 
          <td>
                  <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="Expiry Date" name="expiry[]">
            
          </td> 

           <td>
            <input type="hidden" name="total" value="<?php echo $product['quantity'] * $product['cost']; ?>">
            NGN <?php echo number_format($product['quantity'] * $product['cost'], 2); ?></td>  
           <td>
               <a href="purchase.php?action=delete&id=<?php echo $product['id']; ?>">
