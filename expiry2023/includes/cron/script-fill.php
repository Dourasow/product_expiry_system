    ...
    $query15 = "(SELECT*  from company_tbl WHERE comp_id=1)
              ...
              if (mysqli_num_rows($result15) > 0) {
                ...
                $rep4=$row['report4'];
                                ...
                                $head="
<h1 style='color:blue'>$coy</H1><h3>Detailed Sales Report from $range1 to $range2 as at $time</h3><br>
