        ...
        <div class="sidebar-brand-text mx-3">Home</div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="poso.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">POS</span>
              </a>
            </li>

            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="poso.php?role=clear" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">CLEAR S.O</span>
              </a>
            </li>

            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="poso.php?actionx=new" target="blank" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">OPEN NEW S.O</span>
              </a>
            </li>

            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="so_detail.php" target="blank" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">TRACK S.O</span>
              </a>
            </li>
