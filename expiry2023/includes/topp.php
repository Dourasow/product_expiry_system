      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Home</div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php?role=clear" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">CLEAR SALES</span>
              </a>
            </li>

            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php?actionx=new" target="blank" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">OPEN NEW POS</span>
              </a>
            </li>

            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="transaction.php" target="blank" role="button">
                <span class="mr-2 d-none d-lg-inline  small" style="color: brown;">SALES HIST.</span>
              </a>
            </li>
